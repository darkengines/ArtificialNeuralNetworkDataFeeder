{
"TrainingDataFilePath": "config.js",
"HiddenLayers": [10,8,3],
"UninitializedDataProvider": {
    "InputDataPickers": [{
        "Index": 0,
        "Indicator": {
            "$type": "ArtificialNeuralNetworkDataFeeder.DataIndicator.MovingAverageIndicator, ArtificialNeuralNetworkDataFeeder",
            "DataProcessor": {
                "$type": "ArtificialNeuralNetworkDataFeeder.DataProcessors.MovingAverageDataProcessor, ArtificialNeuralNetworkDataFeeder",
                "Period": 12
            }
        },
        "Normalizer": {
